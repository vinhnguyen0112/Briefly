...
function extractPageContent() {
  ...
  try {
    ...
    if (mainContent.trim() === '') {
      ...
      const contentDivs = document.querySelectorAll(contentDivSelectors.join(', '));
...
function extractStructuredData() {
  ...
  const apiElements = document.querySelectorAll('.api, .endpoint, .method, .parameter, .response');

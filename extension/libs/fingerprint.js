            ...
            v = function () {
              try {
                ...
                switch ((i(r) && u(r), n.state)) {
                  ...
                  case "suspended":
                    document.hidden || d++,
                      s && d >= e ? l(T("suspended")) : setTimeout(v, t);
                }
              } catch (o) {
                l(o);
              }
      ...
      switch (t.label) {
        case 0:
          for (
            ...
            "DIALOG" === (u = _(n[s])).tagName && u.show(),
              on((l = e.createElement("div"))),
              l.appendChild(u),
              i.appendChild(l),
              (a[s] = u);
          t.label = 1;
      ...
      return e(n, void 0, void 0, function () {
        ...
        return t(this, function (t) {
          for (
            ...
            (r[B[f]] = s[f].offsetWidth), (o[B[f]] = s[f].offsetHeight);
          return [
            2,
            O.filter(function (n) {
              return l(d[n]);
  ...
  webGlExtensions: function (n) {
    ...
    if (t)
      for (var h = 0, p = t; h < p.length; h++) {
        ...
        if (
          !(
            ("WEBGL_debug_renderer_info" === b && Sn()) ||
            ("WEBGL_polygon_mode" === b && (Y() || j()))
          )
        ) {
          var y = e.getExtension(b);
          if (y)
            for (var g = 0, w = kn(y); g < w.length; g++) {
              var L;
              v = y[(L = w[g])];
              c.push(
                ""
                  .concat(L, "=")
                  .concat(v)
                  .concat(bn.has(v) ? "=".concat(e.getParameter(v)) : "")
              );
            }
          else o.push(b);
        }
      }
    for (var k = 0, V = yn; k < V.length; k++)
      for (var S = V[k], W = 0, x = gn; W < x.length; W++) {
        var Z = x[W],
          R = Ln(e, S, Z);
    ...
    e(this, void 0, void 0, function () {
      ...
      return t(this, function (t) {
        switch (t.label) {
          case 0:
            return (
              n.monitoring, (e = n.delayFallback), (r = n.debug), [4, Gn(e)]
            );
          case 1:
            return (
              t.sent(),
...
var Yn = { load: In, hashComponents: Mn, componentsToDebugString: Rn },
  jn = Z;
export {
